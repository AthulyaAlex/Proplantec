...
public final class ComplaintAction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            ");
            ...
            String seQry = "select * from tbl_complaint f inner join tbl_user u on f.user_id=u.user_id where f.complaint_id ='" + request.getParameter("cid") + "'";
      ...
      out.write("            <tr>\n");
      out.write("                <td>");
      out.print(r.getString("user_name"));
      out.write("</td>\n");
      out.write("                <td>");
