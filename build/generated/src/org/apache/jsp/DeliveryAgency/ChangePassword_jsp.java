package org.apache.jsp.DeliveryAgency;
...
public final class ChangePassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/DeliveryAgency/Head.jsp");
    _jspx_dependants.add("/DeliveryAgency/Foot.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("         <style>\n");
      out.write("/*            .bg-img {\n");
      out.write("                background-image: url(\"../Assets/Templates/Main/assets/img/agency.jpg\");\n");
      ...
      out.write("    ");
       ...
       String pass ="";
       String sq = "select*from tbl_agent where agent_id ='"+session.getAttribute("gid")+"'";
       ResultSet rs = con.selectCommand(sq);
       rs.next();
       pass = rs.getString("agent_password");
       ...
       {      
        if(pass.equals(currentpsswd))
        {
            ...
            {
                String uq = "update tbl_agent set agent_password = '"+request.getParameter("txtnpsswd")+"'where agent_id = '"+session.getAttribute("gid")+"'";
      ...
      out.write("        <td><input type=\"password\" class=\"text-box\" name=\"txtpsswd\" placeholder=\"Enter Current Password\" title=\"Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters\" pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{8,}\" required></td>\n");
      out.write("    </tr\n");
      out.write("    <tr>\n");
      out.write("        <td>New Password</td>\n");
      out.write("        <td><input type=\"password\" class=\"text-box\" name=\"txtnpsswd\" placeholder=\"Enter New Password\" title=\"Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters\" pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{8,}\" required></td>\n");
      out.write("    </tr>\n");
      out.write("    <tr>\n");
      out.write("        <td>Re-Password</td>\n");
      out.write("        <td><input type=\"password\" class=\"text-box\" name=\"txtrpsswd\" placeholder=\"ReEnter Password\" required></td>\n");
      out.write("    </tr>\n");
      out.write("    <tr>\n");
