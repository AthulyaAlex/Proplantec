        ...
        <form method="post"  enctype="multipart/form-data" action="../Assets/Actionpages/AgentUploadAction.jsp">
            <table border="3" align="center">
                ...
                <tr>
                    <td>Proof</td>
                    <td align="center">
                        <input required type="file" name="txtprf">
                    </td>
                </tr>
                <tr>
                    <td>Photo</td>
                ...
                <tr>
                    <td>Password</td>
                    <td>
                        <input required type="password" name="txtpsswd" placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required name="txt_pass">
                    </td>
                </tr>
                <tr>
