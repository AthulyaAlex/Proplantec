...
<%
    ...
    if (request.getParameter("rating_data") != null) {
        ...
        String ins = "INSERT INTO tbl_review(user_name,user_rating,user_review,review_datetime,agent_id)"
                + "VALUES('" + request.getParameter("user_name") + "','" + request.getParameter("rating_data") + "','" + request.getParameter("user_review") + "',SYSDATE(),'" + request.getParameter("aid") + "')";
    ...
    if (request.getParameter("action") != null) {
        ...
        String query = "SELECT * FROM tbl_review where agent_id = '" + request.getParameter("id") + "' ORDER BY review_id DESC";
